...
DISTRICT_CHOICES_ARIA_LABELS = (
    ('1', '1 - Alabama - ND - Northern District'),
    ('2', '2 - Alabama - MD - Middle District'),
    ('3', '3 - Alabama - SD - Southern District'),
    ('9', '9 - Arkansas - ED - Eastern District'),
    ('10', '10 - Arkansas - WD - Western District'),
    ('11', '11 - California - ND - Northern District'),
    ('11E', '11E - California - ED - Eastern District'),
    ('12', '12 - California - SD - Southern District'),
    ('12C', '12C - California - CD'),
    ('17', '17 - Florida - ND - Northern District'),
    ('17M', '17M - Florida - MD - Middle District'),
    ('18', '18 - Florida - SD - Southern District'),
    ('19', '19 - Georgia - ND - Northern District'),
    ('19M', '19M - Georgia - MD - Middle District'),
    ('20', '20 - Georgia - SD - Southern District'),
    ('23', '23 - Illinois - ND - Northern District'),
    ('24', '24 - Illinois - CD'),
    ('25', '25 - Illinois - SD - Southern District'),
    ('26', '26 - Indiana - ND - Northern District'),
    ('26S', '26S - Indiana - SD - Southern District'),
    ('27', '27 - Iowa - ND - Northern District'),
    ('28', '28 - Iowa - SD - Southern District'),
    ('30', '30 - Kentucky - ED - Eastern District'),
    ('31', '31 - Kentucky - WD - Western District'),
    ('32', '32 - Louisiana - ED - Eastern District'),
    ('32M', '32M - Louisiana - MD - Middle District'),
    ('33', '33 - Louisiana - WD - Western District'),
    ('37', '37 - Michigan - ED - Eastern District'),
    ('38', '38 - Michigan - WD - Western District'),
    ('40', '40 - Mississippi - ND - Northern District'),
    ('41', '41 - Mississippi - SD - Southern District'),
    ('42', '42 - Missouri - ED - Eastern District'),
    ('43', '43 - Missouri - WD - Western District'),
    ('50', '50 - New York - ND - Northern District'),
    ('51', '51 - New York - SD - Southern District'),
    ('52', '52 - New York - ED - Eastern District'),
    ('53', '53 - New York - WD - Western District'),
    ('54', '54 - North Carolina - ED - Eastern District'),
    ('54M', '54M - North Carolina - MD - Middle District'),
    ('55', '55 - North Carolina - WD - Western District'),
    ('57', '57 - Ohio - ND - Northern District'),
    ('58', '58 - Ohio - SD - Southern District'),
    ('59', '59 - Oklahoma - ED - Eastern District'),
    ('59N', '59N - Oklahoma - ND - Northern District'),
    ('60', '60 - Oklahoma - WD - Western District'),
    ('62', '62 - Pennsylvania - ED - Eastern District'),
    ('63', '63 - Pennsylvania - MD - Middle District'),
    ('64', '64 - Pennsylvania - WD - Western District'),
    ('70', '70 - Tennessee - ED - Eastern District'),
    ('71', '71 - Tennessee - MD - Middle District'),
    ('72', '72 - Tennessee - WD - Western District'),
    ('73', '73 - Texas - ND - Northern District'),
    ('74', '74 - Texas - SD - Southern District'),
    ('75', '75 - Texas - ED - Eastern District'),
    ('76', '76 - Texas - WD - Western District'),
    ('79', '79 - Virginia - ED - Eastern District'),
    ('80', '80 - Virginia - WD - Western District'),
    ('81', '81 - Washington - ED - Eastern District'),
    ('82', '82 - Washington - WD - Western District'),
    ('83', '83 - West Virginia - ND - Northern District'),
    ('84', '84 - West Virginia - SD - Southern District'),
    ('85', '85 - Wisconsin - ED - Eastern District'),
    ('86', '86 - Wisconsin - WD - Western District'),
)
